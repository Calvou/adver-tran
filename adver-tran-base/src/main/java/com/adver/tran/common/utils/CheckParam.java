...
public class CheckParam {
	...
	public static boolean isNull(String str) {
		//return str == null || "".equals(str.trim()) || "null".equals(str.trim()) || "undefined".equals(str.trim())|| "string".equals(str.trim());
	...
	public static boolean isStrNumber(String str){
		return !isNull(str) && str.matches("-?[0-9]+.*[0-9]*");
	}
